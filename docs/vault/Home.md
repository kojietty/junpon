...
このページは [[docs/vault]] のハブです。全ノートはここから辿れます。
...
- [[05-assets/asset-list|必要素材リスト]]

---

## 📌 運用ルール（CLAUDE.md と同期）

- 設計判断・仕様変更が出たら、該当ノートを **その場で** 更新する
- 当日初めて触る場合は `04-logs/YYYY-MM-DD.md` を作って意思決定を記録する
- ノート間は `[[wikilink]]` で接続し、ここから辿れる状態を維持する
- 詳細は [プロジェクトルートの CLAUDE.md](../../CLAUDE.md) を参照
